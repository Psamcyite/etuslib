...
export const UserRegistrationSchema: ZodType<UserRegistrationProps> = z
  ...
  .refine((schema: { password: any; confirmPassword: any }) => schema.password === schema.confirmPassword, {
    message: 'passwords do not match',
    path: ['confirmPassword'],
  })
  .refine((schema: { email: any; confirmEmail: any }) => schema.email === schema.confirmEmail, {
